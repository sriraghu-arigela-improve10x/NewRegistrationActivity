    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // String designation = intent.getStringExtra("designation");
        ...
        nextBtn.setOnClickListener(view -> {
            ...
            String accountHolder = accountHolderNameTxt.getText().toString();
           ...
           // Toast.makeText(this, emailAddress + "\t" + password + "\t" + confirmPassword + "\t" + userName + "\t" + firstName + "\t" + lastName + "\t" + currentCompany + "\t" + totalExperience + "\t" + designation + "\t" + bankName + "\t" + accountHolder + "\t" + accountNumber + "\t" + ifscCode, Toast.LENGTH_SHORT).show();
           ...
           // bankAccountIntent.putExtra("designation", designation);
            ...
            bankAccountIntent.putExtra("accountHolder", accountHolder);
